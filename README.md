<p align="center"><img src="assets/Artifacts_context_kit.png" width="520" alt="Newsletter Context Kit — teach your AI agents how you think and write. Built in public by Artifacts."></p>
...
This kit was built in the open, dogfooded on the [Artifacts](https://artifactstech.substack.com) newsletter. The reasoning trail lives in [`docs-build-in-public/`](docs-build-in-public/) — [decisions](docs-build-in-public/decisions.md) (D1–D29, each with a "reverses if"), [the journey](docs-build-in-public/user-journey.md), [open questions](docs-build-in-public/open-questions.md), [devlog](docs-build-in-public/devlog.md) — and the method specs behind each skill in [`method/`](method/). *(The author's own Artifacts context isn't shipped — your `newsletter-context/` is generated fresh from your archive.)*
